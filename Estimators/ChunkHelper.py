...
class ChunkHelper:
    ...
    def _create_mhtml_summary(chunk_filepath, chunk_data, selected_files, chunks_dir):
        ...
        mhtml_filepath = os.path.splitext(chunk_filepath)[0] + '.mhtml'
        ...
        for v in selected_files:
            ...
            # Get score - level2 if done, otherwise level1
            ...
            # Get vacancy title
            vacancy_title = ""
            if 'estimation1' in vacancy_data and vacancy_data['estimation1'].get('json'):
                vacancy_title = vacancy_data['estimation1']['json'].get('Title', '')
            elif 'estimation2' in vacancy_data and vacancy_data['estimation2'].get('json'):
                vacancy_title = vacancy_data['estimation2']['json'].get('Title', '')
